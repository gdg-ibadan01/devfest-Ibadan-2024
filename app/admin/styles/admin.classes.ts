export const AdminClass = {
  container: 'bg-[#F9F9F9] min-h-[95vh] py-10',
  wrapper: 'container mx-auto flex flex-col gap-[20px]',
  title: 'text-2xl font-medium capitalize',
  searchInputContainer:
    'w-full flex flex-wrap items-center justify-between gap-5',
  inputContainer:
    'flex lg:flex-row flex-col gap-5 items-center w-full lg:w-[50%]',
  searchInput:
    'border border-[#F0F0F0] rounded-sm py-[11px] px-[16px] w-full lg:w-[240px] text-[14px] font-light text-[#474C52]',
  dropdown:
    'rounded-sm border border-[#F0F0F0] py-[11px] w-full lg:max-w-[150px] px-5 text-[14px] text-[#474C52] bg-white font-normal',
  exportBtn:
  ...
  addBtn:
    'bg-[#1e1e1e] rounded-[100px] py-[10px] px-[25px] font-medium text-white',
};

export const TableClass = {
  table: 'min-w-full table-auto border-collapse mb-14',
  thead: 'bg-[#F7F7F7] text-left sm:table-header-group',
