...
import Icon1 from '@/public/Group_1.png';
import Icon2 from '@/public/Group_2.png';

export default function Organizers() {
  return (
    <>
      <main className="md:pt-[100px] pt-[80px] bg-pastel-blue min-h-screen">
        {/* Use min-h-screen to ensure the section is at least the full height of the viewport */}
        <div className="bg-[url('/team-mobile.png')] md:bg-[url('/Team.png')] min-h-screen bg-cover bg-center flex items-center justify-center">
