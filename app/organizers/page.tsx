  ...
  return (
    <>
      <main className="md:pt-[100px] pt-[80px] bg-pastel-blue mains min-h-screen ">
        ...
        <div className="bg-[url('/team-mobile.png')] organizer-bg md:bg-[url('/Team.png')] sm :min-h-[94vh] min-h-screen bg-cover bg-center flex items-center justify-center 3xl:bg-contain bg-no-repeat mb-[-10px] md:mb-0">
